...
const speakerData = {
  "Deception By Design: Anti-Piracy Deception In Video Games": {
    title: "Rita Malaquias, Pedro Cardoso, Pamela Teubig and Eva Oliveira",
    location: "In Person",
    description:
  ...
  "The Subversion of User-Friendly Design: Engagement Algorithms and the Erosion of Agency in the Attention Economy":
    {
      title: "Ana Luísa Ferreira and Andreia Pinto de Sousa",
      location: "In Person",
      description:
  ...
  "Otherworldly Encounters: Wild Anecdotes on Interspecies Care": {
    title: "Rosemary Lee and Risk Hazekamp",
    location: "In Person",
    description:
  ...
  "From Flow to Friction: Thinking Spaces in VR and AI": {
    title: "Wolfgang Strauss and Monika Fleischmann",
    location: "In Person",
    description:
  ...
  "Companionship Mechanics in AI-Driven Character Platforms: Deceptive and Friction Design in Character.ai":
    {
      title: "Henrique Miguel, Lara Portelinha and Pedro Cardoso",
      location: "In Person",
      description:
  ...
  "Using Narrative to Identify Frictions: A process for Requirements Definition in Software Projects":
    {
      title: "Caio Gonçalves, Berenice Gonçalves and Gilson Braviano",
      location: "Remote",
      description:
  ...
  "Enraging the Loop: Rage as Aesthetic Friction in Play": {
    title: "Hugo Ramos and Pedro Cardoso",
    location: "In Person",
    description:
  ...
  "Paradoxical Temporalities of Computation: Critical and Speculative Practices":
    {
      title: "Sara Orsi, Miguel Carvalhais and Nuno Correia",
      location: "In Person",
      description:
  ...
  "Designing Ecocentric AI: Rethinking Ecosystem Representation in Large Language Models":
    {
      title:
        "Joana Pestana, Diogo Silva, Miguel Carvalhais and Nuno Jardim Nunes",
      location: "In Person",
      description:
